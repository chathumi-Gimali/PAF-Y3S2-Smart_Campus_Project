          ...
          <div style={{ marginTop:20, padding:"12px 14px", background:"#f0f9ff", borderRadius:10, border:"1px solid #bae6fd" }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"4px 12px" }}>
              {[
                ...
                <div key={a.email} onClick={() => { setForm({ email: a.email, password:"123456" }); setTouched({}); setErrors({}); }}
...
const s = {
  ...
  formSide: { flex:"0 0 440px", background:"#fff", padding:"40px 44px", display:"flex", flexDirection:"column", justifyContent:"center", overflowY:"auto" },
  formTitle: { fontSize:24, fontWeight:800, color:"#0f172a", lineHeight:1.3, marginBottom:6 },
  formSub: { fontSize:13, color:"#64748b", marginBottom:22 },
